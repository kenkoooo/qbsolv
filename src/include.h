...
{ NOTHING = 0,                     // nothing new, do nothing
  ...
  DUPLICATE_HIGHEST_ENERGY =
      2,                 // two cases, solution is unique, duplicate energy
  DUPLICATE_ENERGY = 3,  // two cases, solution is duplicate highest energy
  DUPLICATE_ENERGY_UNIQUE_SOL =
      4,                     // two cases, solution is unique, highest energy
...
void solve(double **val, int maxNodes, int nRepeats, int8_t **solution_list,
...
void check_row_col_qval(int8_t *Q, int maxNodes, double **val, double *Qval,
                        double *Row, double *Col);
void check_Qval(int8_t *Q, int maxNodes, double **val, double *Qval);
void print_opts();
void print_output(int maxNodes, int8_t *Q, long numPartCalls, double energy,
                  double seconds);
...
void print_solutions(int8_t **solution, double *energy_list,
                     ...
                     int *index);
struct sol_man_rslt manage_solutions(int8_t *new_solution,
                                     int8_t **solution_list, double new_energy,
                                     double *QVs, int *solution_counts,
                                     int *Qindex, int nMax, int nbits,
